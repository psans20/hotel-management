...
export default function CustomerForm() {
  ...
  const customers = [
    ...
    { refNo: '6061', name: 'Sonali', motherName: 'Mohini', gender: 'Female', postCode: '326598', mobile: '9974563210', email: 'sona@123', nationality: 'Indian' },
    { refNo: '7627', name: 'Kiran', motherName: 'Nirmala', gender: 'Male', postCode: '874521', mobile: '7894561231', email: 'kiran@123', nationality: 'Indian' },
